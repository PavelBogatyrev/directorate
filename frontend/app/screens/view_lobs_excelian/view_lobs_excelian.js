...
angular.module('bodApp.view_lobs_excelian', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_lobs_excelian', {
            templateUrl: 'screens/view_lobs_excelian/view_lobs_excelian.html',
            controller: 'ViewLobsExcelianCtrl'
        });
    }])

    .controller('ViewLobsExcelianCtrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log','$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log,$q) {
            ...
            var requests = [
                {url: "api/lobsYear/EXCELIAN", widgets:['widget_13_1','widget_13_2'], deviationsStartNum:1},
                {url: "api/lobsMonth/EXCELIAN/" + ConfigurationService.activePeriodOverride, widgets:['widget_13_4','widget_13_5'], deviationsStartNum:7},
                {url: "api/lobsHC/EXCELIAN", widgets:['widget_13_7']}];

            var widgets = [
                { id:'widget_13_1',  key:"revenue", factoryMethod: App.BODBarChart.createBasicBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueBasicBarChartConfiguration(cfg, {hasLegend: true}) },
                    callRender:true},

                {id: 'widget_13_4',  key:"revenue", factoryMethod: App.BODBarChart.createBasicBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueBasicBarChartConfiguration(cfg, {}) },
                    callRender:true},


                {id: 'widget_13_2',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {hasLegend: true}) }
                },
                {id: 'widget_13_5',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {}) }
                },
                {id: 'widget_13_7', factoryMethod: App.LineChart.create,
