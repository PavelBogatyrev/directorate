...
angular.module('bodApp.view_lobs_finx', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_lobs_finx', {
            templateUrl: 'screens/view_lobs_finx/view_lobs_finx.html',
            controller: 'ViewLobsFinXCtrl'
        });
    }])

    .controller('ViewLobsFinXCtrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log', '$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log, $q) {
            ...
            var requests = [
                {url: "api/lobsYear/FinS%20Segment%20X", widgets:['widget_9_1','widget_9_2'], deviationsStartNum:1},
                {url: "api/lobsMonth/FinS%20Segment%20X/" + ConfigurationService.activePeriodOverride,widgets:['widget_9_4','widget_9_5'], deviationsStartNum:7},
                {url: "api/lobsHC/FinS%20Segment%20X", widgets:['widget_9_7']}];
            var widgets = [
                { id:'widget_9_1',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {hasLegend: true}) },
                    callRender:true},

                {id: 'widget_9_4',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {}) },
                    callRender:true},


                {id: 'widget_9_2',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {hasLegend: true}) }
                },
                {id: 'widget_9_5',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {}) }
                },
                {id: 'widget_9_7', factoryMethod: App.LineChart.create,
