...
angular.module('bodApp.view_lobs_auto', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_lobs_auto', {
            templateUrl: 'screens/view_lobs_auto/view_lobs_auto.html',
            controller: 'ViewLobsAutoCtrl'
        });
    }])

    .controller('ViewLobsAutoCtrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log', '$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log, $q) {
            ...
            var requests = [
                {url: "api/lobsYear/AUTOMOTIVE%20BUSINESS", widgets:['widget_11_1','widget_11_2'], deviationsStartNum:1},
                {url: "api/lobsMonth/AUTOMOTIVE%20BUSINESS/" + ConfigurationService.activePeriodOverride,widgets:['widget_11_4','widget_11_5'], deviationsStartNum:7},
                {url: "api/lobsHC/AUTOMOTIVE%20BUSINESS", widgets:['widget_11_7']}];

            var widgets = [
                { id:'widget_11_1',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {hasLegend: true}) },
                    callRender:true},

                {id: 'widget_11_4',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {}) },
                    callRender:true},


                {id: 'widget_11_2',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {hasLegend: true}) }
                },
                {id: 'widget_11_5',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {}) }
                },
                {id: 'widget_11_7', factoryMethod: App.LineChart.create,
