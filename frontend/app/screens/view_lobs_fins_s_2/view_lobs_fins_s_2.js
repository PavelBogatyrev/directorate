...
angular.module('bodApp.view_lobs_fins_s_2', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_lobs_fins_s_2', {
            templateUrl: 'screens/view_lobs_fins_s_2/view_lobs_fins_s_2.html',
            controller: 'ViewLobsFinsS2Ctrl'
        });
    }])

    .controller('ViewLobsFinsS2Ctrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log', '$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log, $q) {
            ...
            var requests = [
                {url: "api/lobsYear/FinS%20Segment%202", widgets:['widget_10_1','widget_10_2'], deviationsStartNum:1},
                {url: "api/lobsMonth/FinS%20Segment%202/" + ConfigurationService.activePeriodOverride, widgets:['widget_10_4','widget_10_5'], deviationsStartNum:7},
                {url: "api/lobsHC/FinS%20Segment%202", widgets:['widget_10_7']}];
            var widgets = [
                { id:'widget_10_1',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {hasLegend: true}) },
                        callRender:true},

                {id: 'widget_10_4',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                    configFunc: function(cfg) { ConfigurationService.revenueStackedBarChartConfiguration(cfg, {}) },
                        callRender:true},


                {id: 'widget_10_2',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {hasLegend: true}) }
                },
                {id: 'widget_10_5',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc: function(cfg) { ConfigurationService.cmLineChartConfiguration(cfg, {}) }
                },
                {id: 'widget_10_7', factoryMethod: App.LineChart.create,
