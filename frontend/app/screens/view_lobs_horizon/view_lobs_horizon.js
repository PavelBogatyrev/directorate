...
angular.module('bodApp.view_lobs_horizon', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_lobs_horizon', {
            templateUrl: 'screens/view_lobs_horizon/view_lobs_horizon.html',
            controller: 'ViewLobsHorizonCtrl'
        });
    }])

    .controller('ViewLobsHorizonCtrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log','$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log,$q) {
            ...
            var requests = [
                {url: "api/horizonLobYear", widgets:['widget_15_1','widget_15_2'], deviationsStartNum:1},
                {url: "api/horizonLobMonth/" + ConfigurationService.activePeriodOverride ,widgets:['widget_15_4','widget_15_5'], deviationsStartNum:7},
                {url: "api/horizonLobHC", widgets:['widget_15_7']}];


            var widgets = [
                { id:'widget_15_1',  key:"revenue", factoryMethod: App.BODBarChart.createVerticalStackedBarChart,
                ...
                {id: 'widget_15_4',  key:"revenue", factoryMethod: App.BODBarChart.createBasicBarChart,
                    configFunc: function(cfg) {
                ...
                {id: 'widget_15_2',  key:"cm", factoryMethod: App.LineChart.create, mockModel:{
                ...
                {id: 'widget_15_5',  key:"cm", factoryMethod: App.LineChart.create,
                    configFunc:function(cfg) {
                ...
                {id: 'widget_15_7', factoryMethod: App.LineChart.create,
                    configFunc:function(cfg) {
