...
angular.module('bodApp.view_revenue_lobs_vsplan_forex', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/view_revenue_lobs_vsplan_forex', {
            templateUrl: 'screens/view_revenue_lobs_vsplan_forex/view_revenue_lobs_vsplan_forex.html',
            controller: 'ViewRLVFCtrl'
        });
    }])

    .controller('ViewRLVFCtrl', ['$scope', '$routeParams', '$http', 'ConfigurationService', 'LabelService', '$log', '$q',
        function ($scope, $routeParams, $http, ConfigurationService, LabelService, $log, $q) {
            ...
            var widgets = [
                {url: 'api/revenueByLobsVsplan', id: 'widget_17_1'},
                {url: 'api/revenueGCoEByLobsVsplan', id: 'widget_17_2'},
                {url: 'api/cmByLobsVsplan', id: 'widget_17_3'},
                {url: 'api/cmGCoEByLobsVsplan', id: 'widget_17_4'}];
            widgets.forEach(function (widget, index) {
                ...
                config.bar.values.font.size = "1.2em";
                widgetView.render();
