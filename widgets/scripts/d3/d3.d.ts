...
declare namespace d3 {
    ...
    interface Transition<Datum> {
        ...
        tween(name: string, any): Transition<Datum>;
    ...
    export function timer(func: (elapsed:number) => any, delay?: number, time?: number): void;
    namespace timer {
    ...
    export module scale {
        ...
        interface Linear<Range, Output> {
            ...
            interpolate(a): (a: Range, b: Range) => (t: number) => Output;
            clamp(): boolean;
